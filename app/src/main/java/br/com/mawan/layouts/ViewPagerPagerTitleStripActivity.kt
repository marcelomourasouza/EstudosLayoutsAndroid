...
import kotlinx.android.synthetic.main.activity_view_pager_pager_title_strip.*

class ViewPagerPagerTitleStripActivity : AppCompatActivity() {

    private var demoCollection: DemoCollectionPagerAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_view_pager_pager_title_strip)
